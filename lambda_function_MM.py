    ...
    if age is not None:
        ...
        if age < 18 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You must be at least 18 years old or 65 and younger to utilize this service, "
                "Please update your age appropriately",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "You must plan to invest at least $5,001 or more to utilize this service, "
                "Please re-enter an amount more than $5,000"
        )
